...
impl MessageHandler<UserCreatedEventMessage> for UserCreatedHandler {
    fn handle(&self, message: Box<UserCreatedEventMessage>) -> Result<(), HandleError> {
        ...
        println!("In Brenda Po Lok Fahida's (2306152304) Computer. Message received: {:?}", message);
        Ok(())
    }
...
fn main() {
    ...
    // bonus : let listener = CrosstownBus::new_queue_listener("amqps://qwnwqife:YKHKIRF2M6uyXjbCprsw4LAyol7VaWDb@armadillo.rmq.cloudamqp.com/qwnwqife".to_owned()).unwrap();
